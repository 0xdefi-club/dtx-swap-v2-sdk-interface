...
var e = t(require('jsbi')),
  ...
  i = '0x8615843ab28b4b86b2382dca22cf14f0a6ba9e52cb006531eb574042a5b54a46',
  s = e.BigInt(1e3),
  a = e.BigInt(0),
  c = e.BigInt(1),
  p = e.BigInt(5),
...
var b = 'setPrototypeOf' in Object,
  ...
  E = (function() {
    ...
    t.getAddress = function(t, e) {
      return O({ factoryAddress: '0x61b781d983f5D2134946dF130E9B62962C71b2C0', tokenA: t, tokenB: e })
    }
    var o = t.prototype
    return (
      ...
      (o.getOutputAmount = function(o) {
        ...
        if (e.equal(h.quotient, a)) throw new x()
...
;(exports.FACTORY_ADDRESS = '0x61b781d983f5D2134946dF130E9B62962C71b2C0'),
