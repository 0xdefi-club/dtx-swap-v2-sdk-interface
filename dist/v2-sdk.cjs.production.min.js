...
var I = 'setPrototypeOf' in Object,
  ...
  _ = (function() {
    ...
    t.getAddress = function(t, e) {
      return P({
        factoryAddress:
          t && t.chainId && [84532, 167e3].indexOf(t.chainId)
            ? s[t.chainId]
    ...
    return (
      ...
      (e.getOutputAmount = function(e) {
        ...
        var u = this.reserveOf(e.currency),
          ...
          s = n.multiply(e.quotient, h),
          a = n.multiply(s, i.quotient),
          c = n.add(n.multiply(u.quotient, m), s),
      ...
      (e.getInputAmount = function(e) {
        ...
        var u = this.reserveOf(e.currency),
          ...
          a = n.multiply(n.subtract(u.quotient, e.quotient), h),
        ...
        if (
          ...
          if (n.equal(c, p)) a = e
            ...
            var l = r.sqrt(n.multiply(this.reserve0.quotient, this.reserve1.quotient)),
              h = r.sqrt(c)
            if (n.greaterThan(l, h)) {
              var m = n.multiply(e.quotient, n.subtract(l, h)),
                d = n.add(n.multiply(l, f), h),
                y = n.divide(m, d)
      ...
      for (var y = a.wrapped, v = u.wrapped, T = 0; T < e.length; T++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            r.sortedInsert(c, new t(new C([].concat(s, [A]), n.currency, u), n, r.TradeType.EXACT_INPUT), h, F)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
            t.bestTradeExactIn(k, n, u, { maxNumResults: h, maxHops: d - 1 }, [].concat(s, [A]), q, c)
          }
        }
      }
      return c
    ...
    (t.bestTradeExactOut = function(e, n, u, i, s, a, c) {
      ...
      for (var y = a.wrapped, v = n.wrapped, T = 0; T < e.length; T++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            r.sortedInsert(c, new t(new C([A].concat(s), n, u.currency), u, r.TradeType.EXACT_OUTPUT), h, F)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
            t.bestTradeExactOut(k, n, u, { maxNumResults: h, maxHops: d - 1 }, [A].concat(s), q, c)
          }
        }
      }
      return c
    ...
    (t.swapCallParameters = function(t, e) {
      ...
      switch (t.tradeType) {
        ...
        case r.TradeType.EXACT_OUTPUT:
          m && o(!1),
            n
              ? ((i = 'swapETHForExactTokens'), (s = [l, f, c, h]), (a = p))
              : u
              ? ((i = 'swapTokensForExactETH'), (s = [l, p, f, c, h]), (a = '0x0'))
              : ((i = 'swapTokensForExactTokens'), (s = [l, p, f, c, h]), (a = '0x0'))
      }
